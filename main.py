...
def crear_word(datos_airtable):
    ...
    for idx, plantilla_path in enumerate(plantillas, start=1):
        ...
        acta = cargar_imagen(docx_tpl, 'acta', 'acta.png', 200, 'height', datos_airtable)
        ...
        caldera = cargar_imagen(docx_tpl, 'caldera', 'caldera.jpg', 50, 'heigth', datos_airtable)
        brigadas = cargar_imagen(docx_tpl, 'brigadas', 'brigadas.jpg', 50, 'heigth', datos_airtable)
        hidrante = cargar_imagen(docx_tpl, 'hidrante', 'hidrante.jpg', 50, 'heigth', datos_airtable)
